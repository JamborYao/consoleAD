    ...
    internal class Requests
    {
        public static async Task UserMode()
        {
            ...
            try
            {
                ...
                var groups = await client.Groups
                         //.GetByObjectId("e98c4ce9-e256-42ab-a7cb-d888aefe822f")
                         .Expand(g => g.AppRoleAssignments)
                         .ExecuteAsync();
                         
                         
                 var group= groups.CurrentPage.Where(c=>c.ObjectId== "e98c4ce9-e256-42ab-a7cb-d888aefe822f").FirstOrDefault();
        ...
        public static async Task AppMode()
        {
            ...
            try
            {
                ...
                var group = client.Users.ExecuteAsync().Result.CurrentPage.ToList();
                //foreach (IDirectoryObject directoryObject in group)
                //{
                //    if (directoryObject is Group)
                //    {
                //        Group group1 = directoryObject as Group;
                      
                //    }
                //}
                var groups = await client.Groups
                         .GetByObjectId("ad348970-6cd8-4662-9dc6-6a05ccd84379")
                         .Expand(g => g.AppRoleAssignments)
                         .ExecuteAsync();
            }
            catch (Exception e)
